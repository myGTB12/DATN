        ...
        <li class="list-group-item p-4">
            <div class="d-flex gap-3">
                <div class="flex-shrink-0">
                    <img src="{{asset($reservation->img)}}" class="w-px-100">
                </div>
                <div class="flex-grow-1">
                    <div class="row">
                        <div class="col-md-8">
                            <h6 class="me-3"><a href="" class="text-body"></a></h6>
                            <div class="text-muted mb-1 d-flex flex-wrap" style="padding-bottom: 10px;"><span class="me-1">Car: {{$reservation->car_name}}</span> <a href="" class="me-1"></a> <span class="badge bg-label-primary">{{$reservation->brand}}</span></div>
                            <div class="car-outstanding">
                                <div class="outstanding-features__item">
                                    ...
                                    <div class="title">
                                        <p class="sub">Seats</p>
                                        <p class="main">{{$reservation->capacity}}
                                            seats</p>
                                    </div>
                                </div>
                                <div class="outstanding-features__item">
