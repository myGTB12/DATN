@extends('layouts/contentNavbarLayout', ['isMenu' => false])

@section('title', 'Account settings ' . __('messages.title'))
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      ...
      <hr class="my-0">
      <div class="card-body">
        <form id="formAccountSettings" method="POST" action="{{route('user.profile', $user->id)}}">
          @csrf
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              <label for="state" class="form-label">Strict</label>
              <input class="form-control" type="text" id="state" name="strict" value="{{$user->strict}}" />
            </div>
            <div class="mb-3 col-md-6">
